    ...
    <div className="navbar bg-base-100 shadow-sm px-4 lg:px-12">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 gap-1">
          <li><a className="font-medium text-gray-600 hover:text-violet-600">Products</a></li>
      ...
      <div className="navbar-end gap-2">
        <button className="btn btn-ghost btn-circle relative">
          ...
          <span className="badge badge-xs badge-primary absolute -top-1 -right-1 text-white">0</span>
        </button>
